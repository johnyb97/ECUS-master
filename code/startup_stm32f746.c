...
//default All Fucked Up handler
void __attribute__((weak)) AFU_handler(void)
{
	volatile SCB_Type copy=*SCB;
	(void)copy;
...
void __attribute__((weak)) NMI_Handler(void){ AFU_handler();}
void __attribute__((weak)) HardFault_Handler(void){ AFU_handler();}
void __attribute__((weak)) MemManage_Handler(void){ AFU_handler();}
void __attribute__((weak)) BusFault_Handler(void){ AFU_handler();}
void __attribute__((weak)) UsageFault_Handler(void){ AFU_handler();}
